...
## Examples
- From scratch pipeline: `examples/complex_dic_pipeline.py`
- Registry pipeline: `examples/complex_dic_pipeline_registry.py`
- Validate all: `examples/validate_all.py`

## Artifacts
- Demonstrators generated by examples: `dic_pipeline.json`, `dic_pipeline_registry.json`
